...
class Server {
    ...
    protected boolean canServe() {
        return (this.iD < 1 ? false : this.customer == null);
    }

    protected boolean canQueue() {
        return (this.iD < 1 ? false : !this.canServe() && this.customerWaiting == null);
    }
    ...
    public String toString() {
        return "Server " + this.iD + " Stats: " + this.busyTill + " " + this.customer + " " + this.customerWaiting + "\n";
    }
}
